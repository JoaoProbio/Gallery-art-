...
$caminho = basename(getcwd()) == "group9" ? "" : "../"; ?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
 <meta charset="UTF-8">
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
 <title>Livro de Visitas | PHP Procedural</title>
 <link
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
 <div class="container">
  <a class="navbar-brand" href="<?php echo $caminho; ?>index.php">📝 Livro de Visitas</a>
  ...
  <ul class="navbar-nav me-auto">
   ...
   <li class="nav-item">
    <a class="nav-link" href="<?php echo $caminho; ?>index.php">Ver Comentários</a>
   </li>
   <?php if (
