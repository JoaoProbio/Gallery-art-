...
if (isset($_SESSION["usuario_logado"])):
    ...
    $sql =
        "SELECT id, nome, telefone, email, data_nascimento FROM contatos ORDER BY nome ASC";
...
<h1 class="mb-4">Lista Completa de Contatos 📘</h1>
 ...
 <p class="h5 text-muted">Total de contatos: **<?php echo mysqli_num_rows(
     $resultado,
 ); ?>**</p>
 ...
 <td>
 <a href="contatos_editar.php?id=<?php echo $contato[
     "id"
 ]; ?>" class="btn btn-sm btn-warning me-2">Editar</a>
 <a
 href="processa.php?acao=excluir_contato&id=<?php echo $contato["id"]; ?>"
 class="btn btn-sm btn-danger"
 onclick="return confirm('Tem certeza que deseja EXCLUIR o contato: <?php echo htmlspecialchars(
     $contato["nome"],
 ); ?>?');">
 Excluir
 </a>
...
<?php
 ...
 <div class="card-body">
 <p class="text-center text-muted">Credencial de teste: **admin** / **123456**</p>
