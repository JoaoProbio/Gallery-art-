...
$stmt = mysqli_prepare(
    $conn,
    "SELECT nome, telefone, email, data_nascimento, endereco FROM contatos WHERE id = ?",
);
...
<h1 class="mb-4">✏️ Editar Contato: <?php echo htmlspecialchars(
    $contato["nome"],
); ?></h1>
...
<div class="card shadow">
 ...
 <input type="text" class="form-control" id="nome" name="nome" value="<?php echo htmlspecialchars(
     $contato["nome"],
 ); ?>"
 ...
 <input type="text" class="form-control" id="telefone" name="telefone" value="<?php echo htmlspecialchars(
     $contato["telefone"],
 ); ?>" maxlength="20">
 </div>
 <div class="col-md-3 mb-3">
 <label for="data_nascimento" class="form-label">Data de Nasc.:</label>
 <input type="date" class="form-control" id="data_nascimento" name="data_nascimento" value="<?php echo htmlspecialchars(
 ...
 <textarea class="form-control" id="endereco" name="endereco" rows="3"><?php echo htmlspecialchars(
     $contato["endereco"],
 ); ?></textarea>
 </div>
